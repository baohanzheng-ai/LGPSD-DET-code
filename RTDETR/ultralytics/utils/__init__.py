...
def yaml_save(file='LGPSD-DET.yaml', data=None, header=''):
    """
    Save YAML data to a file.

    Args:
        file (str, optional): File name. Default is 'LGPSD-DET.yaml'.
...
def yaml_load(file='LGPSD-DET.yaml', append_filename=False):
    """
